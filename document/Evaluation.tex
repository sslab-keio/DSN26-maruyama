...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.93\linewidth]{graph/CPU_Util/cpu_utilization-user.pdf}
    \caption{Monitoring CPU utilization (user metrics).}
    \label{fig:cpu_util_user}
\end{figure*}

\begin{figure*}[t]
    \centering
    \includegraphics[width=0.93\linewidth]{graph/CPU_Util/cpu_utilization-kernel.pdf}
    \caption{Monitoring CPU utilization (kernel metrics).}
    \label{fig:cpu_util_kernel}
\end{figure*}
