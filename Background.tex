...
%     \hfill
%     % \hfill
%     \begin{minipage}[b]{0.35\textwidth}  % Adjust width as needed
%         \centering
%         \includegraphics[width=\textwidth]{SoCC-2025/figures/experiment/cdf-pre-ycsb-latest.png}
%         \subcaption{CDF of Netdata’s Monitoring Latency Increase Under Load}
%         \label{fig:pre-cdf}
%     \end{minipage}
%     \hfill
%     % Second image (b)
%     \begin{minipage}[b]{0.35\textwidth}  % Adjust width as needed
%         \centering
%         \includegraphics[width=\textwidth]{SoCC-2025/figures/experiment/memcached-throughput.png}
%         \subcaption{Throughput Degradation of Memcached Caused by Netdata}
%         \label{fig:pre-throughput}
%     \end{minipage}
%     \hfill
%     \hfill
%     \caption{Monitoring Latency and Overhead in Netdata}
...
\begin{figure}[t]
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{graph/cdf-pre-ycsb-latest.png}
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{graph/memcached-throughput.png}
