...
% \begin{figure*}[!p]
%   \centering
%   \subfloat[1 instance (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance1-kernel.png}\label{fig:instance1-kernel}}\hfill
%   \subfloat[5 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance5-kernel.png}\label{fig:instance5-kernel}}\hfill
%   \subfloat[10 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-kernel.png}\label{fig:instance10-kernel}}\\[10pt]
%   % \subfloat[10 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-kernel.png}\label{fig:instance10-kernel}}\\
%   \subfloat[interval 1000 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval1000-kernel.png}\label{fig:interval1000-kernel}}\hfill
%   \subfloat[interval 100 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval100-kernel.png}\label{fig:interval100-kernel}}\hfill
%   \subfloat[interval 10 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval10-kernel.png}\label{fig:interval10-kernel}}
%   \caption{Monitoring latency of \textbf{kernel} metrics under varying numbers of Memcached instances and sampling intervals}
%   \label{fig:monitor-latency-kernel}
% \end{figure*}

% \begin{figure*}[!p]
%   \centering
%   \subfloat[1 instance (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance1-user.png}\label{fig:instance1-user}}\hfill
%   \subfloat[5 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance5-user.png}\label{fig:instance5-user}}\hfill
%   \subfloat[10 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-user.png}\label{fig:instance10-user}}\\[10pt]
%   % \subfloat[10 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-user.png}\label{fig:instance10-user}}\\
%   \subfloat[interval 1000 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval1000-user.png}\label{fig:interval1000-user}}\hfill
%   \subfloat[interval 100 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval100-user.png}\label{fig:interval100-user}}\hfill
%   \subfloat[interval 10 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval10-user.png}\label{fig:interval10-user}}
%   \caption{Monitoring latency of \textbf{user} metrics under varying numbers of Memcached instances and sampling intervals}
%   \label{fig:monitor-latency-user}
% \end{figure*}

\begin{figure*}[!p]
  \centering
  \subfloat[1 instance (kernel)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-kernelmetrics-1mcd.png}\label{fig:cdf-kernel-1mcd}}\hfill
  \subfloat[5 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-kernelmetrics-5mcd.png}\label{fig:cdf-kernel-5mcd}}\hfill
  \subfloat[10 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-kernelmetrics-10mcd.png}\label{fig:cdf-kernel-10mcd}}\\[10pt]
  % \subfloat[10 instances (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-kernel.png}\label{fig:instance10-kernel}}\\
  % \subfloat[interval 1000 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval1000-kernel.png}\label{fig:interval1000-kernel}}\hfill
  % \subfloat[interval 100 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval100-kernel.png}\label{fig:interval100-kernel}}\hfill
  % \subfloat[interval 10 ms (kernel)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval10-kernel.png}\label{fig:interval10-kernel}}
...
\begin{figure*}[!p]
  \centering
  \subfloat[1 instance (user)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-usermetrics-1mcd.png}\label{fig:cdf-user-1mcd}}\hfill
  \subfloat[5 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-kernelmetrics-5mcd.png}\label{fig:cdf-user-5mcd}}\hfill
  \subfloat[10 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/Latency/cdf-usermetrics-10mcd.png}\label{fig:cdf-user-10mcd}}\\[10pt]
  % \subfloat[10 instances (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/instance10-user.png}\label{fig:instance10-user}}\\
  % \subfloat[interval 1000 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval1000-user.png}\label{fig:interval1000-user}}\hfill
  % \subfloat[interval 100 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval100-user.png}\label{fig:interval100-user}}\hfill
  % \subfloat[interval 10 ms (user)]{\includegraphics[width=0.33\textwidth]{graph/cdf/interval10-user.png}\label{fig:interval10-user}}
...
%         \centering
%         \includegraphics[width=\textwidth]{graph/cpu-util-instance.png}
%         \subcaption{CPU utilization vs Instances}
%         \label{fig:cpu-util-instance}
%     \end{minipage}
%     \hfill
%     % Second image (b)
%     \begin{minipage}[b]{0.7\columnwidth}  % Adjust width as needed
%         \centering
%         \includegraphics[width=\textwidth]{graph/cpu-util-interval.png}
%         \subcaption{CPU utilization vs Interval}
%         \label{fig:cpu-util-interval}
%     \end{minipage}
%     \hfill
%     % Overall caption
%     \caption{Monitoring CPU utilization.}
%     \label{fig:cpu-util}
% \end{figure}
...
%         \centering
%         \includegraphics[width=\textwidth]{graph/Memcached-throughput-k-met.png}
...
%     \begin{minipage}[b]{0.7\columnwidth}  % Adjust width as needed
%         \centering
%         \includegraphics[width=\textwidth]{graph/Memcached-throughput-u-met.png}
...
%     \centering
%     \includegraphics[width=\textwidth]{graph/cdf-user-pri.png}
...
%     \centering
%     \includegraphics[width=\textwidth]{graph/elapsed-latency-nonpri.png}
...
%   \begin{minipage}[t]{0.30\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{graph/elapsed-latency-pri.png}
...
% \begin{figure}[t]
%     \centering
%     \includegraphics[width=0.8\columnwidth]{graph/Memcached-throughput-u-met-pri.png}
