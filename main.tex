...
To enable an orchestration system to manage each microservice effectively, monitoring services must operate with both low latency and low overhead, allowing them to capture timely service status without compromising service performanceHowever, conventional user-space monitoring tools such as Netdata and Prometheus incur scheduling delays and context switch overhead, resulting in increased monitoring latency and degraded service performance.
